    ...
    <div class="mx-auto max-w-6xl">
      <header class="mb-8 rounded-3xl border-4 border-stone-900 bg-lime-300 p-6 shadow-[8px_8px_0_#111] sm:p-8">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p class="text-xs font-black uppercase tracking-[0.2em] text-stone-800">Option 8</p>
          ...
          <NuxtLink to="/" class="rounded-full border-4 border-stone-900 bg-amber-100 px-4 py-2 text-sm font-black shadow-[4px_4px_0_#111]">
            Back to options
          </NuxtLink>
        </div>
      </header>
      ...
      <section class="grid gap-4 lg:grid-cols-2">
        <article class="block-card bg-rose-300 p-5">
          ...
          <ul class="mt-3 grid gap-2 text-sm font-semibold">
            <li v-for="framework in featuredFrameworks" :key="framework.name" class="rounded-xl border-2 border-stone-900 bg-rose-100 px-3 py-2">
