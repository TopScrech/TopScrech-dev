  ...
  >
    <div class="flex items-center justify-between mb-4">
      ...
      <a
        ...
        class="backdrop-blur-sm bg-white/20 hover:bg-white/30 text-white p-2 rounded-lg transition-all duration-200 border border-white/30 flex items-center gap-1 hover:scale-105"
      >
        <svg
          class="w-4 h-4"
          fill="currentColor"
